ngs.DevicesLoad = Class.create(ngs.AbstractLoad, {
    ...
    initSetPricesButtons: function () {
        jQuery('.f_set_prices').click(function () {
            ...
            var amd100ChargeSeconds = jQuery('#amd_100_charge_seconds' + deviceId).val();
            var amd200ChargeSeconds = jQuery('#amd_200_charge_seconds' + deviceId).val();
            var amd500ChargeSeconds = jQuery('#amd_500_charge_seconds' + deviceId).val();
